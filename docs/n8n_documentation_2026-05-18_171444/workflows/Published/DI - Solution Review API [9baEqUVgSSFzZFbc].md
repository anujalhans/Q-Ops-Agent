...
| Node Count | 15 |
| JSON Source | C:\Users\anujalhans01\Q-Ops_Agent\docs\n8n_workflows_2026-05-18_171444\Published\DI - Solution Review API [9baEqUVgSSFzZFbc].json |
...
- https://ifnznfspkjayhnooncrv.supabase.co/rest/v1/di_reusable_solutions?id=eq.{{
- https://ifnznfspkjayhnooncrv.supabase.co/rest/v1/di_solution_reviews
