...
| Updated At | 2026-05-11T18:15:41.000Z |
| Node Count | 67 |
| JSON Source | C:\Users\anujalhans01\Q-Ops_Agent\docs\n8n_workflows_2026-05-18_171444\Published\RETRIEVAL Document Generator AI Agent - SaaS - Full Clone Draft [fullRetrievalD01].json |
...
```json
{
    ...
    "toolDescription":  "Retrieves project-specific chunks from Chroma for Confluence QA document generation. The hard metadata filter is project; the Prompt Library supplies document-type retrieval profile guidance using docType, documentCategory, artifactType, contentSource, sectionTitle, hasVisionContent, metadataConfidence, and chunkId.",
    ...
    "topK":  "={{ $(\u0027Prompt Library\u0027).item.json.configSnapshot?.chroma?.topK || 20 }}",
    "options":  {
                    "metadata":  {
                                     "metadataValues":  [
                                                            {
...
```json
{
    ...
    "additionalFields":  {
                             "description":  "={{ \n\"**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Epic Description**\\n\" + $json.epicDescription +\n\n\"\\n\\n---\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â½Ãƒâ€šÃ‚Â¯ Business Objective**\\n\" + $json.businessObjective +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¹Ã¢â‚¬Â  Success Metrics**\\n\" + \n$json.successMetrics\n  .replace(/\\sand\\s/g, \u0027, \u0027)     // normalize \"and\" ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ comma\n  .split(\u0027,\u0027)                   // split by comma\n  .map(i =\u003e i.trim())\n  .filter(i =\u003e i !== \"\")\n  .map(i =\u003e \"- [ ] \" + i)\n  .join(\u0027\\n\u0027) +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Source Reference**\\n\" + $json.sourceTraceability\n}}"
                         }
}
```
...
```json
{
    ...
    "additionalFields":  {
                             "description":  "={{ \n\"**User Story**\\n\" + $json.userStory +\n\n\"\\n\\n---\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã¢â‚¬â„¢ Business Context**\\n\" + $json.businessContext +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾ Primary Flow**\\n\" + $json.primaryFlow +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â Alternate Flows**\\n\" + $json.alternateFlows +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Â ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â Exception Handling**\\n\" + $json.exceptionHandling +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ Acceptance Criteria**\\n\" + \n$json.acceptanceCriteria.split(\u0027\\n\u0027).map(i =\u003e \"- [ ] \" + i.replace(/^[-ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¢]\\s*/, \u0027\u0027)).join(\u0027\\n\u0027) +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â½Ãƒâ€šÃ‚Â¨ UI/UX Requirements**\\n\" + $json.uiUxRequirements +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â§Ãƒâ€šÃ‚Âª Test Scenarios**\\n\" + $json.testScenarios +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â¦ Dependencies**\\n\" + $json.dependencies +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã‚Â¡ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÃ‚Â Assumptions**\\n\" + $json.assumptions +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Ã‚Â  Performance NFRs**\\n\" + $json.performanceNFRs +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Traceability**\\n\" + $json.sourceTraceability +\n\n\"\\n\\n**ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¤ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Automation Feasibility**\\n\" + $json.automationFeasibility\n}}",
...
```json
{
    ...
    "options":  {
                    "maxTokens":  "={{ $(\u0027Prompt Library\u0027).item.json.configSnapshot?.models?.maxTokens || 8000 }}"
                }
}
```
...
```json
{
    ...
    "sendBody":  true,
    "specifyBody":  "json",
    "jsonBody":  "={\n  \"status\": \"failed\",\n  \"output\": {\n    \"error\": true,\n    \"message\": \"Quality Gate Failed ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â see n8n execution log for details\"\n  },\n  \"updated_at\": \"{{ $now }}\"\n}",
    "options":  {
