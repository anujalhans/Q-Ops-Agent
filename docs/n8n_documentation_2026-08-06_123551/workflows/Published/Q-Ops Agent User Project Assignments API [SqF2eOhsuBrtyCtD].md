...
| Node Count | 13 |
| JSON Source | C:\Users\anujalhans01\Q-Ops_Agent\docs\n8n_workflows_2026-08-06_123551\Published\Q-Ops Agent User Project Assignments API [SqF2eOhsuBrtyCtD].json |

## Description

PATCH /webhook/users/project-assignments endpoint. Requires an active admin JWT, replaces a registered user’s qops_project_members rows, and writes qops_audit_events.
