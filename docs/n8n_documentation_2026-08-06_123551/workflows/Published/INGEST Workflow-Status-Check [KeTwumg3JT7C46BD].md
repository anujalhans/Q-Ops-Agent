...
| Updated At | 2026-06-01T18:25:20.363Z |
| Node Count | 5 |
| JSON Source | C:\Users\anujalhans01\Q-Ops_Agent\docs\n8n_workflows_2026-08-06_123551\Published\INGEST Workflow-Status-Check [KeTwumg3JT7C46BD].json |
...
```json
{
    ...
    "queryParameters":  {
                            "parameters":  [
                                               ...
                                               {
                                                   "name":  "select",
                                                   "value":  "job_id,status,output,error"
                                               }
                                           ]
                        },
    "sendHeaders":  true,
...
```json
{
    "jsCode":  "const inputJobId = $(\u0027Edit Fields\u0027).first().json.jobId;\n\nif (!$json || !$json.job_id) {\n  return [\n    {\n      json: {\n        jobId: inputJobId,\n        status: \"not_found\"\n      }\n    }\n  ];\n}\n\nreturn [\n  {\n    json: {\n      jobId: $json.job_id,\n      status: $json.status,\n      output: $json.output || null,\n      error: $json.error || null\n    }\n  }\n];"
}
```
