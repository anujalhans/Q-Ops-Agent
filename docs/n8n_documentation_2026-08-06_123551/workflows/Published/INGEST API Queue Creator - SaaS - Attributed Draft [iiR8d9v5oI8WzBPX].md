...
| Node Count | 16 |
| JSON Source | C:\Users\anujalhans01\Q-Ops_Agent\docs\n8n_workflows_2026-08-06_123551\Published\INGEST API Queue Creator - SaaS - Attributed Draft [iiR8d9v5oI8WzBPX].json |

## Description

Upload queue creator with Supabase Auth validation before Supabase Storage upload.
...
- Verify Supabase Auth User -> Split Binary Files for Supabase Upload (source output 0, target input 0)
...
- Build File URL Map -> Fetch Q-Ops User Profile (source output 0, target input 0)
...
| Field | Value |
| --- | --- |
| Node ID | 486897f0-995d-449e-8201-15a3989b7f98 |
...
- Build File URL Map -> Fetch Q-Ops User Profile (output 0, input 0)
...
```json
{
    "url":  "=https://ifnznfspkjayhnooncrv.supabase.co/rest/v1/qops_users?auth_user_id=eq.{{ $(\"Verify Supabase Auth User\").first().json.id }}\u0026status=eq.active\u0026select=id,email,name,role,status\u0026limit=1",
...
| Field | Value |
| --- | --- |
| Node ID | ab71109d-974b-4382-a3b1-8a7aea036c57 |
| Type | n8n-nodes-base.code |
| Type Version | 2 |
| Position | 1120, 192 |
| Disabled |  |
...
- Verify Supabase Auth User -> Split Binary Files for Supabase Upload (output 0, input 0)
...
| Field | Value |
| --- | --- |
| Node ID | ae7af659-228d-4f77-90eb-6dbac9d885e5 |
| Type | n8n-nodes-base.httpRequest |
| Type Version | 4.4 |
| Position | 1344, 192 |
| Disabled |  |
...
{
    "method":  "POST",
    "url":  "=https://ifnznfspkjayhnooncrv.supabase.co/storage/v1/object/uploaded-project-docs/{{ encodeURIComponent($json.projectId || $json.projectName || \"unknown-project\") }}/{{ $json.jobId }}/{{ encodeURIComponent($json.fileName) }}",
    "authentication":  "genericCredentialType",
    "genericAuthType":  "httpCustomAuth",
    "sendHeaders":  true,
    "specifyHeaders":  "json",
...
| Field | Value |
| --- | --- |
| Node ID | 111f06c3-6c63-4fad-9f89-e966406b9952 |
